...
async function POST(req) {
    try {
        ...
        const existingPost = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Post$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            slug
        });
        const finalSlug = existingPost ? `${slug}-${Date.now()}` : slug;
        const post = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Post$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            title,
            content,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0qlkbhq._.js.map