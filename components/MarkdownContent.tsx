...
function processYouTubeEmbeds(content: string): string {
  ...
  <div class="relative w-full aspect-video rounded-2xl overflow-hidden border border-foreground/15 dark:border-white/15 bg-black shadow-xl cursor-pointer flex items-center justify-center">
    <img 
      src="https://i.ytimg.com/vi/${videoId}/maxresdefault.jpg" 
      onError="this.onerror=null;this.src='https://i.ytimg.com/vi/${videoId}/mqdefault.jpg';"
      alt="Video Thumbnail"
